...
function gr(e, n, t, r, l) {
    ...
    if (u)
        ...
        gr(l, n, t, "", function(c) {
            return c
        })) : l != null && (Wo(l) && (l = vc(l, t + (!l.key || u && u.key === l.key ? "" : ("" + l.key).replace(ju, "$&/") + "/") + e)),
        n.push(l)),
        1;
    if (u = 0,
    r = r === "" ? "." : r + ":",
...
var He = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u")
  ...
  , $u = {};
function Lc(e) {
    return Yl.call($u, e) ? !0 : Yl.call(Uu, e) ? !1 : zc.test(e) ? $u[e] = !0 : (Uu[e] = !0,
    !1)
}
function Tc(e, n, t, r) {
    if (t !== null && t.type === 0)
...
var Ls, bo, Ts, Rs, Os, co = !1, ir = [], tn = null, rn = null, ln = null, Dt = new Map, It = new Map, qe = [], bc = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function Xu(e, n) {
    switch (e) {
    case "focusin":
    case "focusout":
...
function Is() {
    if (Sr)
        return Sr;
    var e, n = nu, t = n.length, r, l = "value"in en ? en.value : en.textContent, o = l.length;
...
function we(e) {
    function n(t, r, l, o, u) {
        ...
        for (var i in e)
            ...
            this[i] = t ? t(o) : o[i]);
        return this.isDefaultPrevented = (o.defaultPrevented != null ? o.defaultPrevented : o.returnValue === !1) ? sr : Zu,
...
function Tf(e, n) {
    if (In)
        return e === "compositionend" || !lu && js(e, n) ? (e = Is(),
        Sr = nu = en = null,
        In = !1,
        e) : null;
    switch (e) {
...
function $s(e, n, t, r) {
    vs(r),
    n = jr(n, "onChange"),
    0 < n.length && (t = new tu("onChange","change",null,t,r),
    e.push({
        event: t,
        listeners: n
    }))
...
function Df(e, n, t) {
    ...
    _t = n,
    jt = t,
    _t.attachEvent("onpropertychange", Vs)) : e === "focusout" && li()
}
function If(e) {
...
function ii(e, n, t) {
    ...
    Nt && Ut(Nt, r) || (Nt = r,
    r = jr(po, "onSelect"),
    0 < r.length && (n = new tu("onSelect","select",null,n,t),
    e.push({
        event: n,
        listeners: r
    }),
...
function $t(e) {
    if (!e[cr]) {
        ...
        ls.forEach(function(t) {
            t !== "selectionchange" && (Wf.has(t) || Ml(t, !1, e),
            Ml(t, !0, e))
        });
        ...
        if (!(n & 7)) {
            e: {
                ...
                g !== w)) {
                    ...
                    f = "onMouseEnter",
                    a = "mouse",
                    (e === "pointerout" || e === "pointerover") && (k = bu,
                    v = "onPointerLeave",
                    f = "onPointerEnter",
                    a = "pointer"),
                    F = g == null ? p : Un(g),
            ...
            e: {
                ...
                x && x(e, p, c),
                e === "focusout" && (x = p._wrapperState) && x.controlled && p.type === "number" && eo(p, "number", p.value)
            }
            switch (x = c ? Un(c) : window,
            e) {
            case "focusin":
                (ti(x) || x.contentEditable === "true") && (Fn = x,
                po = c,
                Nt = null);
                break;
            case "focusout":
            ...
            N && (Fs && t.locale !== "ko" && (In || N !== "onCompositionStart" ? N === "onCompositionEnd" && In && (_ = Is()) : (en = h,
            nu = "value"in en ? en.value : en.textContent,
            In = !0)),
            x = jr(c, N),
            0 < x.length && (N = new qu(N,e,null,t,h),
            m.push({
                event: N,
                listeners: x
            }),
            _ ? N.data = _ : (_ = Us(t),
            _ !== null && (N.data = _)))),
            (_ = zf ? Lf(e, t) : Tf(e, t)) && (c = jr(c, "onBeforeInput"),
            0 < c.length && (h = new qu("onBeforeInput","beforeinput",null,t,h),
            m.push({
                event: h,
                listeners: c
            }),
...
function ua(e, n, t) {
    var r = !1
      , l = dn
      , o = n.contextType;
    return typeof o == "object" && o !== null ? o = xe(o) : (l = de(n) ? _n : re.current,
    r = n.contextTypes,
...
function _o(e, n, t, r) {
    ...
    pu(e);
    var o = n.contextType;
    typeof o == "object" && o !== null ? l.context = xe(o) : (o = de(n) ? _n : re.current,
    l.context = bn(e, o)),
    l.state = e.memoizedState,
...
function ia(e) {
    ...
    function s(f, a, d, v) {
        var E = d.type;
        return E === Dn ? h(f, a, d.props.children, v, d.key) : a !== null && (a.elementType === E || typeof E == "object" && E !== null && E.$$typeof === Ze && Ei(E) === a.type) ? (v = l(a, d.props),
        v.ref = ht(f, a, d),
        v.return = f,
    ...
    function k(f, a, d, v) {
        ...
        d == null)
            throw Error(y(151));
        for (var x = E = null, _ = a, N = a = 0, B = null, T = d.next(); _ !== null && !T.done; N++,
        T = d.next()) {
            _.index > N ? (B = _,
            _ = null) : B = _.sibling;
...
function Ea(e, n) {
    ...
    return r !== null && n !== null && yu(n, r[1]) ? r[0] : (t.memoizedState = [e, n],
    e)
}
function Ca(e, n) {
    var t = _e();
    n = n === void 0 ? null : n;
    var r = t.memoizedState;
    return r !== null && n !== null && yu(n, r[1]) ? r[0] : (e = e(),
    t.memoizedState = [e, n],
    e)
}
function xa(e, n, t) {
...
function Li(e, n, t, r, l) {
    if (e === null) {
        var o = t.type;
        return typeof o == "function" && !Lu(o) && o.defaultProps === void 0 && t.compare === null && t.defaultProps === void 0 ? (n.tag = 15,
        n.type = o,
...
function Ti(e, n, t, r, l) {
    ...
    n.stateNode === null)
        ...
        var s = u.context
          , c = t.contextType;
        typeof c == "object" && c !== null ? c = xe(c) : (c = de(t) ? _n : re.current,
        c = bn(n, c));
        ...
        s = n.memoizedState),
        (i = Je || ki(n, t, i, r, p, s, c)) ? (m || typeof u.UNSAFE_componentWillMount != "function" && typeof u.componentWillMount != "function" || (typeof u.componentWillMount == "function" && u.componentWillMount(),
        ...
        p = u.context,
        s = t.contextType,
        typeof s == "object" && s !== null ? s = xe(s) : (s = de(t) ? _n : re.current,
        s = bn(n, s));
        ...
        w = n.memoizedState),
        (c = Je || ki(n, t, c, r, p, w, s) || !1) ? (h || typeof u.UNSAFE_componentWillUpdate != "function" && typeof u.componentWillUpdate != "function" || (typeof u.componentWillUpdate == "function" && u.componentWillUpdate(r, w, s),
...
function zo(e, n, t, r, l, o) {
    ...
    n.child = nt(n, null, i, o)) : le(e, n, i, o),
...
function Da(e) {
    var n = e.stateNode;
    n.pendingContext ? mi(e, n.pendingContext, n.pendingContext !== n.context) : n.context && mi(e, n.context, !1),
                ...
                e: {
                    ...
                    for (o in i)
                        if (i.hasOwnProperty(o)) {
                            ...
                            s != null && ps(e, s)) : o === "children" ? typeof s == "string" ? (t !== "textarea" || s !== "") && Ot(e, s) : typeof s == "number" && Ot(e, "" + s) : o !== "suppressContentEditableWarning" && o !== "suppressHydrationWarning" && o !== "autoFocus" && (Rt.hasOwnProperty(o) ? s != null && o === "onScroll" && D("scroll", e) : s != null && Ko(e, o, s, u))
                        }
                    switch (t) {
                    case "input":
                        rr(e),
        ...
        u === null)
            ...
            if (!r)
                ...
                e !== null) {
                    ...
                    2 * H() - o.renderingStartTime > lt && t !== 1073741824 && (n.flags |= 128,
                    r = !0,
                    vt(o, !1),
                    n.lanes = 4194304);
...
function Wa(e, n) {
    ...
    case 13:
        ...
        !o || l.alternate !== null && l.alternate.memoizedState !== null || (_u = H())),
        r & 4 && Ii(e);
        break;
    case 22:
            ...
            if (!u) {
                ...
                (te = s) && !c)
                    for (S = l; S !== null; )
                        u = S,
                        s = u.child,
                        u.tag === 22 && u.memoizedState !== null ? Ui(l) : s !== null ? (s.return = u,
                        S = s) : Ui(l);
                for (; o !== null; )
                    S = o,
                    Ha(o),
...
function an(e) {
    return e.mode & 1 ? R & 2 && q !== 0 ? q & -q : qf.transition !== null ? (zr === 0 && (zr = Ps()),
    zr) : (e = O,
    e !== 0 || (e = window.event,
...
function kd(e, n, t) {
    ...
    Z === e && (q & t) === t && (Y === 4 || Y === 3 && (q & 130023424) === q && 500 > H() - _u ? Cn(e, 0) : xu |= t),
    pe(e, n)
}
function Za(e, n) {
    n === 0 && (e.mode & 1 ? (n = ur,
...
Ja = function(e, n, t) {
    ...
    case 13:
        return Ia(e, n, t);
    case 4:
        return mu(n, n.stateNode.containerInfo),
        r = n.pendingProps,
...
var Rd = es.exports
  , Wi = Rd;
Kl.createRoot = Wi.createRoot,
Kl.hydrateRoot = Wi.hydrateRoot;
const Ql = (e, n) => {
    try {
        const t = window;
...
function Od() {
    ...
    , []);
    const i = () => {
        const s = ["Không", "Cậu có chắc không?", "Nếu Tớ hỏi thật tử tế thì sao?", "Làm ơn đi", "Thêm một chiếc bánh gạo sô cô la lên trên", "Hay là một chiếc kem phủ matcha", "....", "Nhưng :*(", "Tớ sắp chết rồi,nếu cậu không đồng ý", "Ừ, tớ chết rồi", "Được rồi, cậu đang nói chuyện với hồn ma của tớ", "Làm ơn đi cậu", ":((((", ".....", "Đi mà", "Không :("];
        return s[Math.min(e, s.length - 1)]
    }
    ;
    return se.jsx("div", {
        className: "-mt-16 flex h-screen flex-col items-center justify-center",
        children: t ? se.jsxs(se.Fragment, {
            children: [se.jsx("img", {
                src: "https://media.tenor.com/gUiu1zyxfzYAAAAi/bear-kiss-bear-kisses.gif"
            }), se.jsx("div", {
                className: "my-4 text-4xl font-bold",
                children: "WOOOOOO!!! tớ yêu cậu:333!! ;))"
            })]
        }) : se.jsxs(se.Fragment, {
            children: [se.jsx("img", {
                className: "h-[200px]",
                ...
                children: "Cậu đồng ý trở thành valentine của tớ chứ?"
            }), se.jsxs("div", {
...
Kl.createRoot(document.getElementById("root")).render(se.jsx(kc.StrictMode, {
    children: se.jsx(Od, {})
}));
